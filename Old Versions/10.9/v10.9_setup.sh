...
# ---------- Templates ----------
# public_profile.html (completely rewritten)
...
{"name":"link-platform","version":"10.9.0","type":"module","scripts":{"dev":"vite","build":"vite build","preview":"vite preview"},"dependencies":{"react":"^18.2.0","react-dom":"^18.2.0","react-router-dom":"^6.20.0","axios":"^1.6.0","qrcode.react":"^3.1.0"},"devDependencies":{"@vitejs/plugin-react":"^4.1.0","vite":"^4.5.0"}}
EOF
...
🛠️ V10.9 NEW FEATURES:
  ✅ Profile Layout: Left / Center / Right alignment
  ✅ Photo Styles: Circle / Pulse / Glow / Rainbow / Rounded / Square
  ✅ Upload buttons for all image fields (with preview)
  ✅ Fixed: Page Background, Header Style, Tab Styles
  ✅ Report modal on profile and standalone /report page
  ✅ Standalone Report page (linked from profile footer)

🛠️ COMMANDS:
  $DOCKER_COMPOSE logs -f backend
  $DOCKER_COMPOSE logs -f frontend
  $DOCKER_COMPOSE restart
  $DOCKER_COMPOSE down -v && bash v10.9.sh   # full reset
