    ...
    <div>
      ...
      <main style={{ maxWidth: 1000, margin: '0 auto', padding: '2rem' }}>
        ...
        <div style={{ display: 'flex', gap: '.5rem', marginBottom: '2rem', borderBottom: '1px solid var(--border)', paddingBottom: '1rem', flexWrap: 'wrap' }}>
          {[['basic', '👤 Basic'], ['social', '📱 Social Icons'], ['tabs', '📑 Tabs & Links'], ['settings', '🔒 Profile Settings']].map(([t, l]) => (
...
✅ NEW: 🔒 Profile Settings tab — Verified Badge, Sensitive Content, Age Restriction, Cookie Popup, Share Icon, Remove Branding, Password Protection, Display Avatar, Avatar Style
✅ Tab Background Opacity — FIXED: slider now correctly controls image visibility
✅ Tab Style — FIXED: Solid/Glass/Frost/Transparent now work correctly with and without images
✅ Tab Text Color — per-tab color picker overrides theme text color
✅ All previous features: 2FA, ban/suspend, messages, password reset, @slug styles preserved
